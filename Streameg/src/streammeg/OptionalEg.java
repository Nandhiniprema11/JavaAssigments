...
public class OptionalEg {
	...
	private static String getAllStringValues(List<String> strlist) {
		Optional<String> st=   strlist.stream().filter(str->str.startsWith("R")).findFirst();
		//Optional<String> st1=   strlist.stream().filter(str->str.startsWith("R")).f();To get second value loop is needed
