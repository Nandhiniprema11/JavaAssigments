...
public class StreamEgJava7 {
	...
	public static void main(String[] args) {
		...
		List<Integer> intlist = Arrays.asList(1,3,8,4,6,9,7,2); //wrapper integer to primitive integer
...
//1,3,8,4,6,9,7,2
	...
	private static long getEmptyStringsFromList(List<String> strlist) {
		...
		for(String str:strlist) {
			...
			if(str.isEmpty()) {
				System.out.println("22222222222=="+count);
				count++;
				System.out.println("3333333=="+count);
			}
		}
